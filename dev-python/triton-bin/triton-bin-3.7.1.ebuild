...
#
# Version: torch-2.14 nightly (git 3a221655) pins triton 3.8.0 (pytorch
# .ci/docker/triton_version.txt, commit pin 4774139f); 3.7.1 is the newest
# published wheel — one minor behind the pin, two ahead of 3.6.0 which
# miscompiled an inductor vocab-gather (grpo_04 OOB-assert, 2026-07-22). vllm's CUDA kernels (slot mapping,
