...
#
# Forked from ::gentoo ddcutil-2.2.6 (2026-09-18) for one patch: a monitor
# reporting an MCCS version outside the spec (ASUS PG34WCDN answers feature
# xDF with "2.18") made libddcutil abort its client on an assert, so ddcui
# died with SIGABRT whenever the feature view was opened. Still unfixed
# upstream in 3.0.1 — drop this fork once upstream validates the version.
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-2.2.6-invalid-mccs-version.patch
)
